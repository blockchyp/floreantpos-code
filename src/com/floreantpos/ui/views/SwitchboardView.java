...
public class SwitchboardView extends ViewPanel implements ActionListener, ITicketList, TicketListUpdateListener {
	...
	private SwitchboardView() {
		...
		orderServiceExtension = (OrderServiceExtension) DevExtensionManager.getPlugin(OrderServiceExtension.class);
	...
	public void rendererOrderPanel() {
		...
		FloorLayoutPlugin floorLayoutPlugin = (FloorLayoutPlugin) DevExtensionManager.getPlugin(FloorLayoutPlugin.class);
