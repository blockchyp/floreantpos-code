...
import com.floreantpos.extension.DevExtensionManager;
...
public class SwitchboardOtherFunctionsDialog extends POSDialog implements ActionListener {
	...
	public SwitchboardOtherFunctionsDialog(SwitchboardView switchboardView) {
		...
		floorLayoutPlugin = (FloorLayoutPlugin) DevExtensionManager.getPlugin(FloorLayoutPlugin.class);
		if (floorLayoutPlugin != null) {
			contentPane.add(btnTableManage);
		}

		ticketImportPlugin = (TicketImportPlugin) DevExtensionManager.getPlugin(TicketImportPlugin.class);
	...
	private void doShowTicketImportDialog() {
		TicketImportPlugin ticketImportPlugin = (TicketImportPlugin) DevExtensionManager.getPlugin(TicketImportPlugin.class);
		if(ticketImportPlugin != null) {
